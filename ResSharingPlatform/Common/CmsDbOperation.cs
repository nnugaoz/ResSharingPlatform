...
{
    public class CmsDbOperation
    {
        protected static string connectionString = ConfigurationManager.ConnectionStrings["CmsDBSrc"].ConnectionString;
        public CmsDbOperation()
        {
