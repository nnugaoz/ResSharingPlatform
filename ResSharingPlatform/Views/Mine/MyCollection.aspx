...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function GetInitList() {
            $('#ActionForm').attr("action", "../../Mine/MyCollectList");
        ...
        /**删除收藏**/
        function deleteMyCollect(myId) {
            var lyr = layer.confirm("您确定删除收藏吗？", function () {
                layer.close(lyr);
                $.ajax({
                    type: "post",
                    url: "../../Mine/DeleteMyCollect",
                    data: "myId=" + myId,
                    dataType: "json",
                    async: false,
...
<form id="ActionForm" action="" method="post" style="height:0px;">
    ...
    <div class="list main-box mt10" style="margin-top:0px;">
        <h1>
            <%: Html.ActionLink("首页", "Index", "Home")%> > <a href="javascript:doSearch('0')" class="ml5 mr5">我的收藏</a>
        </h1>
        <div class="tabtitle mt10" style="font-size:14px;margin-top:0px;">
            排序 &nbsp;&nbsp;
            <a class="curalink" href="javascript:doSearch('5')"><font id = "5">最新收藏</font></a>&nbsp;&nbsp;
