...
<table class="wenkuTable">
    <% 
        foreach (var item in ViewData["reslist"] as List<ResSharingPlatform.Models.MyCollectionByLike_Result>)
        {
            string fileName = "";
            string ext = "";
            ...
            <td>
                <div class="wenkuName">
                    ...
                    <%}else{ %>
                        0
                    <%} %>分
                        <a href="javascript:deleteMyCollect('<%:item.MyID %>')" style="margin-left:20px;vertical-align:middle;" title="删除"><image src="../../Images/delete.png"></image></a>
                    </div>
                </div>
                <div class="wenkuInt">
                    资源名称：<%:item.NAME %> <br />
